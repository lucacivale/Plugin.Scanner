...
using BarcodeScannerPopup = Plugin.Scanner.iOS.Scanners.Popups.BarcodeScannerPopup;
...
using TextScannerPopup = Plugin.Scanner.iOS.Scanners.Popups.TextScannerPopup;
